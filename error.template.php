    ...
    <body>
        ...
        <div id="content">
            ...
            <div style="padding-left:6px;padding-top:6px">
                <h2 id="errtmp" class="pageTitle"><?php echo $title;?></h2>
				<br/>
                <?php echo $content;?>
                <br/><br/><br/><p><b><a href="#" onclick="history.go(-1);return false;"><?php echo gettext("Go Back"); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="home.php"><?php echo gettext("Go to the Home / Dashboard page"); ?></a></b></p>
            </div>
        </div>
        <?php
