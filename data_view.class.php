...
{
    return new DataView($element, $moduleID);
}
...
function &Factory(&$element, $moduleID)
{
    return new Statement($element, $moduleID);
}
...
function &Factory($element, $moduleID)
{
    return new Union($element, $moduleID);
}
...
function &Factory(&$element, $moduleID, &$callerRef)
{
    return new Field($element, $moduleID, $callerRef);
}
...
function &Factory($element, $moduleID, &$callerRef)
{
    return new FilterCondition($element, $moduleID, $callerRef);
}
