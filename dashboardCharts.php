...
if( count($dashCharts) > 0 ){
    foreach($dashCharts as $dashChart){
        $url = 'chartViewer.php?dsbc='.$dashChart['DashboardChartID'].'&mini=1';
        ...
        $content .= sprintf(
            ...
            '<a href="charts.php?mdl='.$dashChart['ModuleID'].'&amp;dsbc='.$dashChart['DashboardChartID'].'"><img id="'.$chartID.'" width="300" height="200" src="'.$load_url.'" alt="'.gettext("chart").'" /></a>'
