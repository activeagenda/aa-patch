...
function renderPDF($recordID)
{
    ...
    header( 'content-disposition: attachment; filename="'.$this->reportPage->filename.'.xdp"' );
...
function renderMSXML($recordID)
{
    ...
    header( 'content-disposition: attachment; filename="'.$this->reportPage->filename.'.xml"' );
