...
?>
                            <div class="tabg">
                                <a class="tabb" id="tabNotify" href="#" onclick="window.open('frames_popup.php?mdl=ntf<?php echo  $rel ?>', 'notify', 'toolbar=0')" title="<?php echo gettext("Send a new notification of this record") ?>"><?php echo gettext("Notify") ?></a>
                            </div>
<?php
                    }
?>
