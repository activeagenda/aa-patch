...
if( !empty($_POST['Save']) ){
    ...
    if( verifyPassword('Password') ){
        ...
        if( count($r) > 0 ){
			...
			$messages[] = array('m', gettext("New password was saved."));
...
if( $User->requireNewPassword ){
	...
	$intro .= '<p>'.gettext("Proceeding indicates that you have read and accept all the terms of service.")."</p><br/>\n";
}else{
	$intro = '<br/>';
}
