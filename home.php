...
if( !isset( $_SESSION['navigationList'] ) ){
	include_once CLASSES_PATH . '/navigator.class.php';
	$navigator = new Navigator($User->PersonID);
	$menuHTML = $navigator->renderHTML();
    $_SESSION['navigationList'] = $menuHTML ;
}
$menuHTML = $_SESSION['navigationList'];
