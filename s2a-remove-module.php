 ...
 * @version        SVN: $Revision: 1735 $
 * @last-modified  SVN: $Date: 2009-09-01 18:01:00 +0200 (Wt, 01 wrz 2009) $
 */
...
//$keep_xml_file is defined in the *including* file, if needed
...
if($everything){
    ...
    if(file_exists(GENERATED_PATH . '/'.$moduleID)){
...
if($everything && !(isset($uninstall_keep_xml) && $uninstall_keep_xml)){
