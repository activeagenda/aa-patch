...
function menu_toggel( nodeID ){
	var toggledA = document.getElementById( 'MT'+nodeID );
	var firstUL = document.getElementById( nodeID ).getElementsByTagName('ul')[0];
	if( firstUL != null ){
		if( firstUL.style.display == null || firstUL.style.display == 'block' ){
			firstUL.style.display = 'none';
			toggledA.className = 'mndown';
		}else{
			firstUL.style.visibility = "hidden";
			setTimeout( function() {firstUL.style.visibility = "visible";}, 300 );
			firstUL.style.display = 'block';
			toggledA.className = 'mnup';
		}
	}
}
